...
(function (t) {
	...
	(function (t) {
		...
		function n(t, e) {
			...
			return (a || u) && 'true' === t.getAttribute(D)
				? (t.removeAttribute(D),
				  ...
				  (n = t.getAttribute(F)),
				  parseInt(n, 10) >= 0 && (t.setAttribute('maxLength', n), t.removeAttribute(F)),
				  (r = t.getAttribute(P)),
				  r && (t.type = r),
				  !0)
				: !1;
		...
		function a(t) {
			...
			return '' === t.value && n
				? (t.setAttribute(D, 'true'),
				  ...
				  (t.className += ' ' + I),
				  (r = t.getAttribute(F)),
				  r || (t.setAttribute(F, t.maxLength), t.removeAttribute('maxLength')),
				  (e = t.getAttribute(P)),
				  e
						? (t.type = 'text')
						: 'password' === t.type && M.changeType(t, 'text') && t.setAttribute(P, 'password'),
				  !0)
				: !1;
		}
		function u(t, e) {
			...
			if (t && t.getAttribute(V)) e(t);
				...
				for (
					a = t ? t.getElementsByTagName('input') : b,
						u = t ? t.getElementsByTagName('textarea') : f,
						r = a ? a.length : 0,
						n = u ? u.length : 0,
						o = 0,
						l = r + n;
		...
		function o(t) {
			return function () {
				m && t.value === t.getAttribute(V) && 'true' === t.getAttribute(D)
					? M.moveCaret(t, 0)
					: n(t);
			};
		}
		...
		function s(t) {
			return function (e) {
				return (
					(A = t.value),
					'true' === t.getAttribute(D) && A === t.getAttribute(V) && M.inArray(C, e.keyCode)
		...
		function p(t) {
			t.form &&
				...
				M.addEventListener(t, 'focus', o(t)),
				M.addEventListener(t, 'blur', c(t)),
				m &&
					(M.addEventListener(t, 'keydown', s(t)),
					M.addEventListener(t, 'keyup', d(t)),
					M.addEventListener(t, 'click', g(t))),
		...
		if (((K.nativeSupport = void 0 !== G.placeholder), !K.nativeSupport)) {
			for (
				b = document.getElementsByTagName('input'),
					...
					m = 'false' === J.getAttribute(q),
					h = 'false' !== J.getAttribute(z),
				...
				(N = b.length > w ? b[w] : f[w - b.length]),
					(x = N.attributes.placeholder),
					x && ((x = x.nodeValue), x && M.inArray(B, N.type) && p(N));
					...
					(N = b.length > w ? b[w] : f[w - b.length]),
						...
						x
							? ((x = x.nodeValue),
							  x &&
									M.inArray(B, N.type) &&
									(N.getAttribute(j) || p(N),
									(x !== N.getAttribute(V) || ('password' === N.type && !N.getAttribute(P))) &&
										('password' === N.type &&
											!N.getAttribute(P) &&
											M.changeType(N, 'text') &&
											N.setAttribute(P, 'password'),
										N.value === N.getAttribute(V) && (N.value = x),
										N.setAttribute(V, x))))
							: N.getAttribute(D) && (n(N), N.removeAttribute(V));
				h || clearInterval(L);
			}, 100);
		}
		M.addEventListener(t, 'beforeunload', function () {
			...
			(K.disable = K.nativeSupport ? e : i),
			(K.enable = K.nativeSupport ? e : l);
	})(this);
